...
do
    ...
    do
        ...
        do
            ...
            fileout=etapa1/${hh}/gfs.t${Z}z.pgrb2f${tfct}.${dataanl}_APCP.grib2

            fileout_nc=etapa2/${hh}/gfs.t${Z}z.pgrb2f${tfct}.${dataanl}_APCP.nc
...
#:TMP:surface:
            ...
            do
                arq_prev=${gribs}/${yyyymm}/${ddhh}/gfs.t${temp}z.pgrb2f${tfct}.${dataanl}.grib2
                echo "acumula APCP ${arq_prev}"
                #~/bin/wgrib2 $arq -append -match ":APCP:" -grib  $fileout
            done
...
do
    ...
    do
        ...
        #cdo -r mergetime etapa2/${i}/gfs.tz.pgrb2f${tfct}.201401??${i}_APCP.nc etapa3/${i}/prev.2014.jan_APCP_${i}z_${tfct}h.nc
        echo "previsao: ${tfct}"
        echo "${i}"
        echo "cdo -r mergetime etapa2/${i}/gfs.tz.pgrb2f${tfct}.201401??${i}_APCP.nc etapa3/${i}/prev.2014.jan_APCP_${i}z_${tfct}h.nc"
    done
done
