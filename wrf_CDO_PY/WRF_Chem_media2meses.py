...
ds = xr.open_mfdataset("/dados/dmdpesq/WRF-Chem/wrfout_d01_2018-*RAINC.nc", engine="pynio")
wc_RAINC = ds['RAINC'].groupby('XTIME.month').mean('XTIME')
ds.close()
print("OK RAINC")

#exit(0)
ds = xr.open_mfdataset("/dados/dmdpesq/WRF-Chem/wrfout_d01_2018-*RAINNC.nc", engine="pynio")
wc_RAINNC = ds['RAINNC'].groupby('XTIME.month').mean('XTIME')
ds.close()
print("OK RAINNC")

wc_t = wc_RAINC + wc_RAINNC 
...
title = "WRF_20180809_RAINC_RAINNC.png"
