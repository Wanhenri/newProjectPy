...
#corr, _ = pearsonr(lista_umidadeGL, lista_umidadeNova)
...
for ind in range(0,7,1):
    ...
    plt.figtext(.4,.90,'Pearson’s Correlation    ' + longName[8:30] + '      modelRef: MERGE' ,fontsize=30,ha='center')
    ...
    title = 'regiao_'+ config['Regiao'][ind] +'_'+ config['Setor'][ind]+'_PearsonCorr_PREC_withMERGE.png'
